          ...
          {tab === 1 && (
            <>
              ...
              >
                ...
                <p>XLSX · CSV · PPTX / 파일당 최대 100MB</p>
                <input
                  type="file"
                  multiple
                  accept=".xlsx,.csv,.pptx"
