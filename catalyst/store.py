...
def init():
    ...
    with db() as c:
        ...
        CREATE TABLE IF NOT EXISTS part_rules(period TEXT NOT NULL,part TEXT NOT NULL,customer TEXT NOT NULL,reason TEXT NOT NULL,enabled INTEGER NOT NULL,updated TEXT NOT NULL,PRIMARY KEY(period,part));
